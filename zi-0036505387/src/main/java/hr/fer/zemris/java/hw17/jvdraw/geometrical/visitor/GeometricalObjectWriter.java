...
public class GeometricalObjectWriter implements GeometricalObjectVisitor {
    ...
    public void visit(FilledTriangle filledTriangle) {
        try {
            writer.write(
                    String.format(
                            "FTRIANGLE %d %d %d %d %d %d %d %d %d %d %d %d%n",
                            filledTriangle.getA().x,
                            filledTriangle.getA().y,
                            filledTriangle.getB().x,
                            filledTriangle.getB().y,
                            filledTriangle.getC().x,
                            filledTriangle.getC().y,
