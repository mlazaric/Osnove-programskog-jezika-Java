...
public class LinkedListIndexedCollection<E> implements List<E> {
	...
	public void insert(E value, int position) {
		...
		if (position == size) {
			...
			ListNode<E> current = findNodeByIndex(position);
	...
	public void remove(int index) {
		...
		ListNode<E> toRemove = findNodeByIndex(index);
	...
	{
		return new LinkedListElementGetter<E>(this);
	}
	 ...
	 *
	 */
	private static class LinkedListElementGetter<E> implements ElementsGetter<E> {
		 ...
		 */
		private LinkedListElementGetter(LinkedListIndexedCollection<E> collection) {
